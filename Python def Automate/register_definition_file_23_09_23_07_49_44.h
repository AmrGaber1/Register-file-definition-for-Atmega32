/*==========================================================================================
Name        : register_definition_file_23_09_23_07_49_44.h
Author      : Amr Gaber
Description : C Header file for the Atmega32
Date        : 23/09/2023 07:49:44
============================================================================================*/
#ifndef REGISTER_DEFINITION_FILE_23_09_23_07_49_44_H_
#define REGISTER_DEFINITION_FILE_23_09_23_07_49_44_H_
...
#define SREG_REG      (*(volatile SREG_reg_type * const)0x5F)
/*SREG Bit Macros*/
...
#define SPH_REG      (*(volatile SPH_reg_type * const)0x5E)
/*SPH Bit Macros*/
...
#define SPL_REG      (*(volatile SPL_reg_type * const)0x5D)
/*SPL Bit Macros*/
...
#define GICR_REG      (*(volatile GICR_reg_type * const)0x5B)
/*GICR Bit Macros*/
...
#define GIFR_REG      (*(volatile GIFR_reg_type * const)0x5A)
/*GIFR Bit Macros*/
...
#define TIMSK_REG      (*(volatile TIMSK_reg_type * const)0x59)
/*TIMSK Bit Macros*/
...
#define _TIMSK_OCIE1B_POSITION          0x3
#define _TIMSK_OCIE1B_MASK              0x8
#define _TIMSK_OCIE1A_POSITION          0x4
#define _TIMSK_OCIE1A_MASK              0x10
#define _TIMSK_TICIE1_POSITION          0x5
...
#define TIFR_REG      (*(volatile TIFR_reg_type * const)0x58)
/*TIFR Bit Macros*/
...
#define SPMCR_REG      (*(volatile SPMCR_reg_type * const)0x57)
/*SPMCR Bit Macros*/
...
#define _SPMCR_BLBSET_POSITION          0x3
#define _SPMCR_BLBSET_MASK              0x8
#define _SPMCR_RWWSRE_POSITION          0x4
...
#define TWCR_REG      (*(volatile TWCR_reg_type * const)0x56)
/*TWCR Bit Macros*/
...
#define MCUCR_REG      (*(volatile MCUCR_reg_type * const)0x55)
/*MCUCR Bit Macros*/
...
#define MCUCSR_REG      (*(volatile MCUCSR_reg_type * const)0x54)
/*MCUCSR Bit Macros*/
#define _MCUCSR_PORF_POSITION           0x0
#define _MCUCSR_PORF_MASK               0x1
#define _MCUCSR_EXTRF_POSITION          0x1
...
#define TCCR0_REG      (*(volatile TCCR0_reg_type * const)0x53)
/*TCCR0 Bit Macros*/
...
#define SFIOR_REG      (*(volatile SFIOR_reg_type * const)0x50)
/*SFIOR Bit Macros*/
...
#define TCCR1A_REG      (*(volatile TCCR1A_reg_type * const)0x4F)
/*TCCR1A Bit Macros*/
#define _TCCR1A_WGM10_POSITION          0x0
#define _TCCR1A_WGM10_MASK              0x1
#define _TCCR1A_WGM11_POSITION          0x1
#define _TCCR1A_WGM11_MASK              0x2
#define _TCCR1A_FOC1B_POSITION          0x2
#define _TCCR1A_FOC1B_MASK              0x4
#define _TCCR1A_FOC1A_POSITION          0x3
#define _TCCR1A_FOC1A_MASK              0x8
#define _TCCR1A_COM1B0_POSITION         0x4
#define _TCCR1A_COM1B0_MASK             0x10
#define _TCCR1A_COM1B1_POSITION         0x5
#define _TCCR1A_COM1B1_MASK             0x20
#define _TCCR1A_COM1A0_POSITION         0x6
#define _TCCR1A_COM1A0_MASK             0x40
#define _TCCR1A_COM1A1_POSITION         0x7
...
#define TCCR1B_REG      (*(volatile TCCR1B_reg_type * const)0x4E)
/*TCCR1B Bit Macros*/
...
#define _TCCR1B_WGM12_POSITION          0x3
#define _TCCR1B_WGM12_MASK              0x8
#define _TCCR1B_WGM13_POSITION          0x4
#define _TCCR1B_WGM13_MASK              0x10
#define _TCCR1B_ICES1_POSITION          0x6
#define _TCCR1B_ICES1_MASK              0x40
#define _TCCR1B_ICNC1_POSITION          0x7
...
#define TCCR2_REG      (*(volatile TCCR2_reg_type * const)0x45)
/*TCCR2 Bit Macros*/
...
#define ASSR_REG      (*(volatile ASSR_reg_type * const)0x42)
/*ASSR Bit Macros*/
...
#define WDTCR_REG      (*(volatile WDTCR_reg_type * const)0x41)
/*WDTCR Bit Macros*/
...
#define UCSRC_REG      (*(volatile UCSRC_reg_type * const)0x40)
/*UCSRC Bit Macros*/
...
#define EEARH_REG      (*(volatile EEARH_reg_type * const)0x3F)
/*EEARH Bit Macros*/
...
#define EECR_REG      (*(volatile EECR_reg_type * const)0x3C)
/*EECR Bit Macros*/
...
#define PORTA_REG      (*(volatile PORTA_reg_type * const)0x3B)
/*PORTA Bit Macros*/
...
#define DDRA_REG      (*(volatile DDRA_reg_type * const)0x3A)
/*DDRA Bit Macros*/
...
#define PINA_REG      (*(volatile PINA_reg_type * const)0x39)
/*PINA Bit Macros*/
...
#define PORTB_REG      (*(volatile PORTB_reg_type * const)0x38)
/*PORTB Bit Macros*/
...
#define DDRB_REG      (*(volatile DDRB_reg_type * const)0x37)
/*DDRB Bit Macros*/
...
#define PINB_REG      (*(volatile PINB_reg_type * const)0x36)
/*PINB Bit Macros*/
...
#define PORTC_REG      (*(volatile PORTC_reg_type * const)0x35)
/*PORTC Bit Macros*/
...
#define DDRC_REG      (*(volatile DDRC_reg_type * const)0x34)
/*DDRC Bit Macros*/
...
#define PINC_REG      (*(volatile PINC_reg_type * const)0x33)
/*PINC Bit Macros*/
...
#define PORTD_REG      (*(volatile PORTD_reg_type * const)0x32)
/*PORTD Bit Macros*/
...
#define DDRD_REG      (*(volatile DDRD_reg_type * const)0x31)
/*DDRD Bit Macros*/
...
#define PIND_REG      (*(volatile PIND_reg_type * const)0x30)
/*PIND Bit Macros*/
...
#define SPSR_REG      (*(volatile SPSR_reg_type * const)0x2E)
/*SPSR Bit Macros*/
...
#define SPCR_REG      (*(volatile SPCR_reg_type * const)0x2D)
/*SPCR Bit Macros*/
...
#define UCSRA_REG      (*(volatile UCSRA_reg_type * const)0x2B)
/*UCSRA Bit Macros*/
...
#define UCSRB_REG      (*(volatile UCSRB_reg_type * const)0x2A)
/*UCSRB Bit Macros*/
...
#define ACSR_REG      (*(volatile ACSR_reg_type * const)0x28)
/*ACSR Bit Macros*/
...
#define ADMUX_REG      (*(volatile ADMUX_reg_type * const)0x27)
/*ADMUX Bit Macros*/
...
#define ADCSRA_REG      (*(volatile ADCSRA_reg_type * const)0x26)
/*ADCSRA Bit Macros*/
#define _ADCSRA_ADPS0_POSITION          0x0
#define _ADCSRA_ADPS0_MASK              0x1
#define _ADCSRA_ADPS1_POSITION          0x1
#define _ADCSRA_ADPS1_MASK              0x2
#define _ADCSRA_ADPS2_POSITION          0x2
...
#define _ADCSRA_ADATE_POSITION          0x5
...
#define TWAR_REG      (*(volatile TWAR_reg_type * const)0x22)
/*TWAR Bit Macros*/
...
#define TWSR_REG      (*(volatile TWSR_reg_type * const)0x21)
/*TWSR Bit Macros*/
...
#define OSCCAL_REG      (*(volatile uint8 * const)0x51)

/*On-Chip Debug Register*/
#define OCDR_REG      (*(volatile uint8 * const)0x51)
...
#define EEARL_REG      (*(volatile uint8 * const)0x3E)

/*EEPROM Data Register*/
#define EEDR_REG      (*(volatile uint8 * const)0x3D)
...
#define TWDR_REG      (*(volatile uint8 * const)0x23)

/*Two-wire Serial Interface Bit Rate Register*/
#define TWBR_REG      (*(volatile uint8 * const)0x20)

#endif /* REGISTER_DEFINITION_FILE_23_09_23_07_49_44_H_ */
